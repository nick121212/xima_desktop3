...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 MutiAlbumResultConfigurationAppend 分部方法。
// </auto-generated>
using System;
...
namespace XIMALAYA.PCDesktop.Core.Data
{
    ...
    public partial class MutiAlbumResultDecorator<T> : Decorator<T>
    {
        ...
        public MutiAlbumResultDecorator(Result<T> result)
            : base(result)
        {
        ...
        public override void doAddConfig()
        {
            ...
            this.Config.MapType<MutiAlbumResult>(map => map
                    ...
                    .Field<XIMALAYA.PCDesktop.Core.Models.Album.AlbumData[]>(field => field.Albums, type => type.To("list"))
            );

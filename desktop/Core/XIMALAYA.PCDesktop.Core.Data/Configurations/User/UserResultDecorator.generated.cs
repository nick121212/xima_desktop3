...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 UserResultConfigurationAppend 分部方法。
// </auto-generated>
using System;
...
namespace XIMALAYA.PCDesktop.Core.Data
{
    ...
    public partial class UserResultDecorator<T> : Decorator<T>
    {
        ...
        public UserResultDecorator(Result<T> result)
            : base(result)
        {
        ...
        {
            base.doAddConfig();
            this.Config.MapType<UserResult>(map => map

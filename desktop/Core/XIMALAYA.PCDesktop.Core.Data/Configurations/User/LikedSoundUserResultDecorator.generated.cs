...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 LikedSoundUserResultConfigurationAppend 分部方法。
// </auto-generated>
using System;
...
{
    /// <summary>
    ///     LikedSoundUserResult
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public partial class LikedSoundUserResultDecorator<T> : Decorator<T>
    {
        ...
        public LikedSoundUserResultDecorator(Result<T> result)
            : base(result)
        {
        ...
        {
            base.doAddConfig();
            this.Config.MapType<LikedSoundUserResult>(map => map
                    ...
                    .Field<System.Int64>(field => field.TotalCount, type => type.To("totalCount"))
                    .Field<XIMALAYA.PCDesktop.Core.Models.User.UserData[]>(field => field.Users, type => type.To("list"))
            );

    ...
    public partial class SearchResultDecorator<T> : Decorator<T>
    {
        ...
        public override void doAddConfig()
        {
            ...
            this.Config.MapType<SearchResult>(map => map
                    ...
                    .Field<XIMALAYA.PCDesktop.Core.Models.Search.SearchAlbumResult>(field => field.AlbumData, type => type.To("album"))
                    .Field<XIMALAYA.PCDesktop.Core.Models.Search.SearchSoundResult>(field => field.SoundData, type => type.To("track"))
                    .Field<XIMALAYA.PCDesktop.Core.Models.Search.SearchUserResult>(field => field.UserData, type => type.To("user"))
            );

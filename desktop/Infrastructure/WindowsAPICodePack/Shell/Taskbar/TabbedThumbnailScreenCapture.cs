    ...
    public static class TabbedThumbnailScreenCapture
    {
        ...
        public static Bitmap GrabWindowBitmap(UIElement element, int dpiX, int dpiY, int width, int height)
        {
            ...
            if (bounds.Height == 0 || bounds.Width == 0 ||
                bounds.Height == double.PositiveInfinity || bounds.Width == double.PositiveInfinity ||
                bounds.Height == double.NegativeInfinity || bounds.Width == double.NegativeInfinity)
                return null;    // Probably hidden

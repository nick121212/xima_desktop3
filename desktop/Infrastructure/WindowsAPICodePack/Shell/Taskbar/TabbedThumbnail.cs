...
namespace Microsoft.WindowsAPICodePack.Taskbar
{
    ...
    public class TabbedThumbnail : IDisposable
    {
        ...
        {
            if (TabbedThumbnailClosing != null)
            {
                TabbedThumbnailClosingEventArgs eventArgs = null;

                if (this.WindowHandle != IntPtr.Zero)
                    eventArgs = new TabbedThumbnailClosingEventArgs(this.WindowHandle, this);
                else if (this.WindowsControl != null)
                    eventArgs = new TabbedThumbnailClosingEventArgs(this.WindowsControl, this);

                TabbedThumbnailClosing(this, eventArgs);
